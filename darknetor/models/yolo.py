...
from darknetor.models.common import *
from darknetor.models.experimental import MixConv2d, CrossConv, C3
from darknetor.utils.general import check_anchor_order, make_divisible, check_file
from darknetor.utils.torch_utils import (time_synchronized, fuse_conv_and_bn,
...
class Model(nn.Module):
    ...
    def _initialize_biases(
        ...
        for mi, s in zip(m.m, m.stride):  # from
            ...
            b[:,
              4] += math.log(8 / (640 / s)**2)  # obj (8 objects per 640 image)
            b[:, 5:] += math.log(0.6 /
